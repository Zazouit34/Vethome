    ...
    <div className="min-h-screen bg-white pb-8">
      ...
      <div className="px-4">
        ...
        <div className="flex flex-col gap-4">
          {annonces.map((a, idx) => (
            <div key={idx} className="bg-white rounded-2xl shadow p-4 flex gap-3 items-start">
              <Image
                src={a.image}
                alt={a.name}
                width={56}
              ...
              <div className="flex-1">
                ...
                <button className="bg-rose-400 hover:bg-rose-500 text-white font-semibold rounded-full px-5 py-1 text-sm transition">Contacter</button>
              </div>
            </div>
          ))}
        </div>
