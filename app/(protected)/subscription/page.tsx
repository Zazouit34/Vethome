      ...
      <div className="max-w-2xl mx-auto py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {plans.map((plan, idx) => (
            <Card 
              key={idx} 
              className={plan.highlight ? "border-2 border-rose-400 shadow-lg" : ""}
            ...
            >
              <CardContent className="flex flex-col items-center py-8">
                ...
                <Button 
                  className="bg-rose-400 hover:bg-rose-500 text-white font-semibold rounded-full px-8 py-2 mt-auto"
                >
                  S'abonner
                </Button>
              </CardContent>
